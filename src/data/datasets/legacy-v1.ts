/** 旧v1〜v9保存の再現専用。通常のデータ編集はplayers・repertoires・teamsで行います。 */
import type { Ability, PitchRepertoire } from '../../engine/types.ts';
import type { GameFixture, GamePlayer, Position, Team, TeamSide } from '../../game/types.ts';
import { GAME_MODEL } from '../../game/model.ts';
