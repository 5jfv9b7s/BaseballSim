...
import { PITCH_MODEL_V4 as m } from './model-v4.ts';
import { swingChance, contactChance } from './pitch-v3.ts';
...
export type PitchV4Step = Omit<PitchStep, 'state'> & {
  state: PitchContext;
...
export function simulatePitchV4(
  input: PitchContext,
  fixture: Fixture,
  commandId: string,
): PitchV4Step {
