...
import { players as awayPlayers } from '../src/data/players/away.ts';
import { repertoires as awayPitches } from '../src/data/repertoires/away.ts';
import { team as awayTeam } from '../src/data/teams/away.ts';
